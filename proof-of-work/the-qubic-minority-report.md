...
As Dr. K pointed out in a Quai space that was primarily dedicated to Qubic's attack, the scarcity of ASICs is not obvious, and should be researched, examined, and not taken for granted. However, I replied that while that is true, the _superfluity_ of ASICs is not something to be taken for granted either, and that's just not something you can say about generic hardware. It is almost the dictionary definition of generic.
